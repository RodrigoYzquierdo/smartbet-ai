...
st.title("📈 SmartBet AI – Apuestas Manuales con Probabilidad Real")
st.markdown("---")
...
if archivo:
    ...
    for i, row in partidos.iterrows():
        ...
        prob_map = {"Local": "H", "Empate": "D", "Visitante": "A"}
        prob_real = probs[prob_map[eleccion]]
        elecciones.append({
